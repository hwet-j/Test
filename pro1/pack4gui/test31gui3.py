...
class MyFrame1 ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"연습", pos = wx.DefaultPosition, size = wx.Size( 360,232 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
        ...
        self.staShow.Wrap( -1 )
        bSizer5.Add( self.staShow, 0, wx.ALL, 5 )
